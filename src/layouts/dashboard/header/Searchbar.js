...
import { Box, Slide, Popper, InputBase, InputAdornment, ClickAwayListener, Autocomplete } from '@mui/material';
...
function Searchbar() {
   ...
   useEffect(() => {
      ...
      // eslint-disable-next-line rseact-hooks/exhaustive-deps
   }, [pathname]);
