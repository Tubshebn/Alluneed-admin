...
// section
import { UserCreateSchema, UserUpdateSchema, defaultValues } from 'src/sections/user/utils/schema';

const useAction = (dialogActionType, row, changeDialogStatus) => {
    const { form } = useForm(UserCreateSchema(), defaultValues, UserUpdateSchema());
